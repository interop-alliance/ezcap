...
receive this file via the include in [AGENTS.md](AGENTS.md).
...
With TypeScript carrying the types, keep JSDoc focused on describing the public
API (it is the API documentation source).
